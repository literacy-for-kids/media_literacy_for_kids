...
1. **Write your opinion** clearly in 2–3 sentences.
2. **Find or imagine the best argument on the other side** — not a strawman, but the strongest, most reasonable version of the opposing view. Write it out in 2–3 sentences.
3. **Evaluate honestly**: Does the other side have any good points? Write one thing from the other side that you can respect, even if you still disagree.
4. **Reflection**: Was this exercise easy or hard? What made it hard? What does that tell you about how your brain handles disagreement?
