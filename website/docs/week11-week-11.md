...
1. **The Context Test** — Show a real photo with a false or misleading caption. (Example: a photo of a crowded beach labeled "Spring Break 2026" that's actually from 2019.) Ask: "Does this photo prove what the caption says?" Then reveal the real context. Discuss: "The photo is real. The caption is the lie. This is called *out-of-context media.*"

2. **Three Ways to Fake It** — Teach the three main ways visual media can be deceptive:
...
1. **Look for Clues** — Practice examining images for signs of manipulation:
...
4. **Build the Checklist** — Together, create a "Fake Spotter's Checklist":
...
1. **A title** (make it catchy — you're an expert now)
2. **The three types of visual fakes** (out of context, manipulated, staged) — write a one-sentence definition for each
3. **Your checklist** (at least 5 things to check)
4. **One real example** of a visual fake you found — describe what it looked like and how you figured out the truth
5. **One tip** — your single best piece of advice for someone who wants to avoid being fooled by images
