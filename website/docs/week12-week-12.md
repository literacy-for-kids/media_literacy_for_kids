...
2. **How the Feed is Built** — Explain the basic mechanics:
...
1. **What was recommended** — the first 3–5 things shown to you
2. **Why you think the algorithm suggested them** — what have you watched, liked, or searched recently that might explain it?
3. **What's MISSING** — what topics, perspectives, or types of content are you probably NOT seeing because of how the algorithm has learned your preferences?
