...
3. **The Color Experiment** — Give the student a simple scene to draw twice: a house with a tree and sky. First time, use only bright, warm colors. Second time, use only dark, cool colors. Compare: "Same house. Same tree. Different feeling. Why?"

4. **Name the Variables** — Introduce the idea that creators have "variables" they can adjust. Write a list together:
...
1. **Two Headlines, One Story** — Write a factual sentence: "City Council voted to cut the park budget by 15%." Now write two headlines:
