...
1. **The Three Shelves** — Review the Ad Tracker results from last week. Ask: "We sorted persuasion into products, clicks, ideas, and feelings. Today we're going deeper into the last two." Introduce three categories of non-product "selling":
...
2. **Example Analysis** — Show your prepared examples one at a time. For each one, ask: "What is this trying to sell? Not a product — an opinion, a feeling, or a behavior?" Have the student identify the category and describe how the media is trying to change them.
...
1. **Name the Techniques** — Together, build a list of common emotional selling techniques:
...
1. **What it is** (describe or sketch the media)
2. **What it's "selling"** (the opinion, feeling, or behavior)
3. **Which technique(s) it uses** (from the list you built in Session 2)
4. **Your rating**: How strong is the emotional pull? (1 = barely noticeable, 5 = very powerful)
