---
sidebar_position: 30
sidebar_label: "Final Project Exemplars"
title: "Final Project Exemplars"
description: "Sample project concepts and mini-models to help students plan their final media project — not scripts to copy, but examples to learn from."
---
...
Each exemplar includes the project format, audience, core message, how evidence and sources are used, what makes it strong, what could go wrong, and how it connects to the [Final Project Rubric](/docs/final-project-rubric).
...
**Looking for the rubric?** See the [Final Project Rubric](/docs/final-project-rubric) for the full evaluation criteria.
