...
2. **The Presentation** — The student presents using the introduction they prepared:
   ...
   - What they want the audience to take away (goal)
   Then they share the project itself — play the video, display the poster, read the blog post, play the podcast, or present the slides.
