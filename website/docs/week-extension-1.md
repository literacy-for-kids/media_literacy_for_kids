...
4. **Why It Matters** — Connect to media literacy: "If AI can create fake photos, fake voices, and fake text that look and sound real, then 'seeing it with your own eyes' is no longer proof that something is true. You need MORE than your eyes. You need your verification skills."
...
1. **Your guess**: Real or AI-generated?
2. **Your evidence**: What clues did you look for? (Hands, text, backgrounds, symmetry, etc.)
3. **Your confidence**: How sure are you? (1 = total guess, 5 = very confident)
