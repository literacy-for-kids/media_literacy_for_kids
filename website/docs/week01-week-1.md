...
4. **Build a Definition** — Together, write a simple working definition. Example: *Media is anything created by someone to share a message, a feeling, or information with other people.*
...
1. What it is (book, sign, label, poster, screen, etc.)
2. Who you think made it
3. One choice the creator made (color, picture, words, size, etc.)
